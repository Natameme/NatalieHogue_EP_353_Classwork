...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 200.0, 68.0, 20.0 ],
					"text" : "Transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 119.0, 259.0, 32.0, 22.0 ],
					"text" : "+ 60"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 816.0, 402.0, 47.0, 22.0 ],
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 593.0, 342.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 306.0, 77.0, 22.0 ],
					"text" : "loadmess 33"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 470.0, 377.0, 82.0, 22.0 ],
					"text" : "midiformat 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 410.0, 47.0, 22.0 ],
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "" ],
					"patching_rect" : [ 119.0, 216.0, 108.0, 22.0 ],
					"text" : "unpack i i n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 342.0, 108.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 119.0, 377.0, 82.0, 22.0 ],
					"text" : "midiformat 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.0, 410.0, 47.0, 22.0 ],
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 119.0, 306.0, 108.0, 22.0 ],
					"text" : "makenote 127 8n"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 602.5, 370.0, 511.0, 370.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 68.5, 248.0, 141.5, 248.0 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "melody.txt",
				"bootpath" : "/Volumes/BerkleeDisk/ClassMaterials/EP-353-AudioProgrammingInC/08.Mid-term",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
