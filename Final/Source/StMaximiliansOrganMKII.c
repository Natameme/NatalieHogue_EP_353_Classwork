...
float bourEight[256], //bourdon 8
      bourFour[256],  //bourdon 4
      clarFour[256],  //clarion 4
      fifTwo[256],    //fifteenth 2
      melEight[256],  //melodia 8
      mixOne[256],    //mixture 1
      octFour[256],   //octave 4
      prinEight[256], //principle 8
...
void loadStops(){
  ...
  for(int i = 0; i <= 256; i++){
    ...
    float phasor = (dex/(256/2)) - 1.0f; //convert floating poin index to value 0 ~ 1
    ...
    //////////////////
                ...
                bourFour[i] =  (sin(phasor *  M_PI * 2.0f * 1.0f * 4.0f) * 0.0316f)+
                   ...
                   //Clarion Four
                clarFour[i] = (0.5 *
                               (sin(phasor *  M_PI * 2.0f * 1.0f  * 4.0f ) * 0.0901f)+
                     ...
                     //Fifteenth two
                  fifTwo[i] = (0.5 *
                              (sin(phasor *  M_PI * 2.0f * 1.0f   * 8.0f ) * 0.116f)+
                     ...
                     //melodia Eight
                  melEight[i] = (0.5 *
                                (sin(phasor *  M_PI * 2.0f * 1.0f * 2.0f ) * 0.331f)+
                     ...
                     //Mixture 1 1/3
                  mixOne[i] = (0.5 *
                              (sin(phasor *  M_PI * 2.0f * 1.0f    * 16.0f ) * 0.0421f)+
                     ...
                     //Octave Four
                  octFour[i] = (0.5 *
                               (sin(phasor *  M_PI * 2.0f * 1.0f    * 4.0f )  * 0.221f)+
                     ...
                     //Principle Eight
                  prinEight[i] = (0.5 *
                                 (sin(phasor *  M_PI * 2.0f * 1.0f  * 2.0f ) * 0.167f)+
                     ...
                     //trumpet 8
                  truEight[i] = (0.5 *
                                (sin(phasor *  M_PI * 2.0f * 1.0f  * 2.0f ) * 0.0346f)+
                                ...
                                //trumpet 16
                  truSixt[i] =  (0.5 *
                                (sin(phasor *  M_PI * 2.0f * (1.0f)  ) * 0.0346f)+
                     ...
                     //Twelfth 2 2/3
                  tweTwo[i] = (0.5 *
                              (sin(phasor *  M_PI * 2.0f * 1.0f   ) * 0.0822f)+
